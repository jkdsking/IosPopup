...
public abstract class BaseDialog {
    ...
    protected void initDefaultSettings() {
        ...
        if (tipTextInfo == null) {
            tipTextInfo = DialogSettings.tipTextInfo;
        }
        if (buttonTextInfo == null) {
            buttonTextInfo = DialogSettings.buttonTextInfo;
        }
        if (inputInfo == null) {
            inputInfo = DialogSettings.inputInfo;
        }
